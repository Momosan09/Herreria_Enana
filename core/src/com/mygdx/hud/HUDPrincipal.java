 ...
 */
public class HUDPrincipal implements HeadUpDisplay, Ocultable, EventoMisionAgregada, BarraItemsSeleccion{
...
//	private Label barraAbajoLbl;
    ...
    public HUDPrincipal(Jugador jugador, Juego juego) {
...
//	    hudDer.setDebug(true);
	...
	public void dibujar() {
		...
		resultadosHUD.dibujar();
		proximaBatallaHUD.dibujar();//Nose porque no funciona el click de proximaBatallaHUD cuando lo quiero usar despues de haber abierto resultadosHUD
		diarioHUD.dibujar();
		horaLabel();
		}
